/**
  ...
  * WOKWI simulation URL: https://wokwi.com/projects/414343153052079105
  * 
  *   Framework: Arduino
  *   Platform: *
  * 
  ...
  * the documentation and experiment with it. In this example the original code
  * sets the MPBttn to keep the On State when it is disabled!!!
  * 
...
void setup() {
  ...
  myDMPBttn.setIsOnDisabled(true);
  myDMPBttn.begin(40); 
}

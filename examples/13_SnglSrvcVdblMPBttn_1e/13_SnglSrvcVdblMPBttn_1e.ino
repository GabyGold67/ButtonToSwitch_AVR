/**
  ******************************************************************************
  * @file	: 13_SnglSrvcVdblMPBttn_1e.ino
  ...
  * WOKWI simulation URL: https://wokwi.com/projects/414367173281549313
  * 
  * Framework: Arduino
  * Platform: *
  * 
  * @details The example instantiates a SnglSrvcVdblMPBttn object using:
...
//------------------------------> SnglSrvcVdblMPBttn class object instantiation
